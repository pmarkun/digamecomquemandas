...
def check_frontend_contracts() -> None:
    ...
    ok('api.admin.bootstrap_sources', 'POLITICS_SOURCES' in bootstrap_service and 'g1.globo.com' in bootstrap_service and 'www1.folha.uol.com.br' in bootstrap_service, 'bootstrap declara fontes políticas')
